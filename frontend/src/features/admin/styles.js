...
export const SB = {
  sidebar: {
    width: 230,
    flexShrink: 0,
    background: 'linear-gradient(155deg, #471420 0%, #601a2a 52%, #8A5319 100%)',
    borderRight: '1px solid rgba(240,180,41,0.22)',
    display: 'flex',
  ...
  logoName: { fontFamily: "'Barlow Condensed', sans-serif", fontSize: 17, fontWeight: 700, color: '#F7CC6A', letterSpacing: '0.05em' },
  logoSub: { fontSize: 10, color: 'rgba(255,255,255,0.52)', letterSpacing: '0.04em', marginTop: 2 },
  sectionLabel: {
    fontSize: 9,
    fontWeight: 700,
  ...
  navIcon: { width: 18, textAlign: 'center', fontSize: 14, flexShrink: 0, color: '#F7CC6A' },
  navSubBtn: {
    display: 'flex',
    alignItems: 'center',
    gap: 8,
  ...
  userName: { fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.86)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  userRole: { fontSize: 10, color: 'rgba(255,255,255,0.46)', textTransform: 'capitalize' },
  signOutBtn: {
...
export const A = {
  ...
  pageTitle: { fontFamily: "'Barlow Condensed', sans-serif", fontSize: 24, fontWeight: 700, color: 'var(--maroon)', letterSpacing: '0.03em' },
  topbarEventMeta: {
    display: 'flex',
    gap: 8,
    flexWrap: 'wrap',
